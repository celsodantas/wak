EstagioRApp::Application.routes.draw do
  ...
  match "/admin/login", :controller => :sessions, :action => :index
  match "/admin/logout", :controller => :sessions, :action => :logout

  match "/admin/sessions", :controller => :sessions, :action => :index
  match "/admin/sessions/new", :controller => :sessions, :action => :new
